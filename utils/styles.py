...
.dv2-ms .top .ttl {{ color: {_text}; font-weight: 600; }}
.dv2-ms .top .ev {{ color: {_faint}; font-size: 0.72rem;
  margin-left: 8px; font-weight: 400; }}
.dv2-ms .top .pc {{ color: {_muted}; font-family: 'JetBrains Mono';
  font-size: 0.7rem; }}
.dv2-ms .mtrack {{ height: 10px;
  background: {'rgba(0,0,0,0.15)' if light else 'rgba(255,255,255,0.12)'};
